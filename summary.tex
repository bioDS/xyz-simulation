...
\end{minipage}
\caption{Precision, recall, and F1 performance measures compared to the number of times each interaction was observed.\todo[inline]{0-100 is not on the graph, this is excluding half the results. Also, check missing values.}}
\end{figure}
